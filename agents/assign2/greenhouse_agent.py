import rospy, ros_hardware, greenhouse_behaviors, ping_behavior, layers
...
class LayeredGreenhouseAgent:
    ...
    def __init__(self,schedulefile):
        ...
        self.ping_behavior = greenhouse_behaviors.Ping()
        behavior_list = [greenhouse_behaviors.Light(), greenhouse_behaviors.RaiseTemp(), greenhouse_behaviors.LowerTemp()
            , greenhouse_behaviors.LowerHumid(), greenhouse_behaviors.LowerSMoist(), greenhouse_behaviors.RaiseSMoist(), self.ping_behavior]
    ...
    def main(self):
        ...
        while not rospy.core.is_shutdown():
            ...
            rospy.sleep(1)
            if rospy.get_time() - last_ping >= 120:
                self.ping_behavior.act()
